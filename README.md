# QED-AI Public Registry

Compact, machine-readable map of QED-AI's public domains, repositories,
applications, information classes, and system boundaries.

The registry exists to make the organization inspectable without requiring a
person or AI system to repeatedly scan every repository. It is authoritative for
public discovery, not for confidential records or access control.
...
and review date. Internal locations and security details are never published.
